      ...
      for (let i = 0; i < 10; i++) {
        copy[i] = {
          title: response.data.data[i].attributes.titles.en
            ? response.data.data[i].attributes.titles.en.length > 16
              ? response.data.data[i].attributes.titles.en.slice(0, 16) + "..."
              : response.data.data[i].attributes.titles.en
            : response.data.data[i].attributes.titles.en_jp.length > 16
            ? response.data.data[i].attributes.titles.en_jp.slice(0, 16) + "..."
